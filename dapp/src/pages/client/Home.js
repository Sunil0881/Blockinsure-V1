              ...
              <div className="">
                   ...
                   <div className='bg-blue-950 grid grid-cols-4 rounded-2xl mb-5 mr-32'>
                    ...
                    <div className=' grid grid-cols-4 rounded-2xl mb-5 mr-32'>
                      <div className='pl-2 py-2'>
                        <img src={tick} width={90} ></img>
                      </div>
                      <div className='col-span-3 '>
                        <h1 className=' text-xl font-semibold py-2 text-black'>Affordable Coverage</h1>
                    ...
                    <div className=' grid grid-cols-4 rounded-2xl mb-5 mr-32'>
                    <div className='pl-2 py-2'>
                        <img src={mail} width={90} ></img>
                      </div>
                      <div className='col-span-3'>
                        <h1 className='text-black text-xl font-semibold py-2'>Affordable Coverage</h1>
      ...
      <div >
        ...
        <div className='flex gap-20 px-20 pt-10 pb-20'>
            <div className='border-2 shadow-2xl '>
              ...
              <img width={200} src={profileboy}></img>
              </div>
              <h1 className='font-bold text-xl flex justify-center'>Deepak</h1>
              <p className='flex justify-center'>Director, Producer</p>
              <div className='flex justify-center py-5'>
              <img  width={150} src={star}></img>
              </div>
            ...
            <div className='border-2 shadow-2xl'>
              <div className='flex justify-center pt-5 '>
              <img width={200} src={profilegirl}></img>
              </div>
              <h1 className='font-bold text-xl flex justify-center'>Deepak</h1>
              <p className='flex justify-center'>Director, Producer</p>
              <div className='flex justify-center py-5'>
      ...
      <footer className='bg-white grid grid-cols-4 pt-16 pb-16'>
        <div className='col-span-2 pl-32' >
          ...
          <div className='flex pt-5 '>
            <img src={facebook} width={40} ></img>
            <img src={instagram} width={40} className='ml-5'></img>
            <img src={twitter} width={40} className='ml-5'></img>
          </div>
        </div>
